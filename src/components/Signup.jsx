...
const Signup = () => {
  ...
  if (signed) return <Navigate to="/products" />;
  ...
  return (
    <motion.div
      ...
      className="min-h-screen flex flex-col md:flex-row items-center justify-center bg-gradient-to-br from-white via-slate-50 to-indigo-50 p-6"
    >
      ...
      >
        ...
        <p className="text-center text-slate-500 mb-6">
          Start managing your products and generating transparent reports.
        </p>
